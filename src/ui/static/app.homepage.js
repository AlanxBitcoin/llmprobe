...
function updateAwrLayerJumpVisibility() {
  if (!window.AppHomepageAwr || typeof window.AppHomepageAwr.updateAwrLayerJumpVisibility !== "function") return;
  return window.AppHomepageAwr.updateAwrLayerJumpVisibility();
}

function updateAwrIgnoreTokenVisibility() {
  if (!window.AppHomepageAwr || typeof window.AppHomepageAwr.updateAwrIgnoreTokenVisibility !== "function") return;
  return window.AppHomepageAwr.updateAwrIgnoreTokenVisibility();
}
...
function initAwrModule() {
  if (!window.AppHomepageAwr || typeof window.AppHomepageAwr.init !== "function") return;
  window.AppHomepageAwr.init({
